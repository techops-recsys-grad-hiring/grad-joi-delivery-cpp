...
#include "Delivery.hpp"  // Assuming Delivery is a class defined elsewhere
...
public:
    ...
    DeliveryPartner(const string& id, const string& name, const vector<Delivery>& del)
        : id(id), name(name), deliveries(del) {}
